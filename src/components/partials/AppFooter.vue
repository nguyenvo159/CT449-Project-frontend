        ...
        <div class="container-fluid pt-5 mt-5 p-3 bg-dark text-white">
            <div class="row justify-content-center font-14px">
                ...
                <div class="col-md-3 col-6 row justify-content-center">
                    <div>
                        ...
                        <p>
                            ...
                            <a href="mailto:nguyenvo1373.hg@gmail.com" style="text-decoration: underline; color: #ffffff;">
                ...
                <div class=" col-md-3 col-6 row justify-content-center">
                    <div>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <router-link :to="{ name: 'productList' }" class="text-white text-decoration-none">
                                    Products
                                </router-link>
                            </li>
                ...
                <div class="mt-3 col-12 text-center">
                    <p>Copyright© 2023 Local Brand Amiri. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
